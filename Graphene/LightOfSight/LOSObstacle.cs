...
namespace LOS {
	...
	public class LOSObstacle : LOSObjectBase {
		[Header("Camera Index")] public int LosCameraIndex = 0;
		...
		public override bool CheckDirty () {
			bool withinScreen = SHelper.CheckWithinScreen(position, LOSManager.instance.GetLosCamera(LosCameraIndex).unityCamera, offScreenDistance) || !Application.isPlaying;
