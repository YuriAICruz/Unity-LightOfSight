...
namespace LOS.Editor {
	...
	public class LOSFullScreenLightEditor : LOSLightBaseEditor {
		...
		public override void OnInspectorGUI () {
			...
			light.LosCameraIndex = EditorGUILayout.IntField("LosCameraIndex", light.LosCameraIndex);

			if (!SHelper.CheckWithinScreen(light.transform.position, LOSManager.instance.GetLosCamera(light.LosCameraIndex).unityCamera, 0)) {
